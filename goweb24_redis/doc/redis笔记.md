...
![image-20211014113414608](./image-20211014113414608.png)
...
![image-20211014172452827](./image-20211014172452827.png)
...
![image-20211014172658264](./image-20211014172658264.png)

### 2. redis的基本属性

1. 16个数据库

   ![image-20211014175806379](./image-20211014175806379.png)
...
3. redis是单线程的
   ...
   ![image-20211014181528486](./image-20211014181528486.png)
...
![image-20211014183155930](./image-20211014183155930.png)
...
![image-20211014184429227](./image-20211014184429227.png)
...
![image-20211018141533778](./image-20211018141533778.png)
...
![image-20211018170827745](./image-20211018170827745.png)
...
![image-20211018180514981](./image-20211018180514981.png)
...
![image-20211023151910798](./image-20211023151910798.png)

### 1. 查看Redis的默认属性

> Properties文件,配置时可参考这个

![image-20211023154644009](./image-20211023154644009.png)

![image-20211023154746732](./image-20211023154746732.png)

![image-20211023154802183](./image-20211023154802183.png)
...
![image-20211023155128418](./image-20211023155128418.png)

-  JedisConnection 导包时会出现异常

  ![image-20211023155628416](./image-20211023155628416.png)

- LettuceConnection 导包时不会出现异常

![image-20211023155805953](./image-20211023155805953.png)
...
![image-20211023161410953](./image-20211023161410953.png)

![image-20211023161629829](./image-20211023161629829.png)
...
![image-20211023165116945](./image-20211023165116945.png)

默认使用的`JDK`,需要调整下为`JSON`

![image-20211023165716431](./image-20211023165716431.png)

实例化之后是``乱码``

![image-20211023170003893](./image-20211023170003893.png)
...
![image-20211023172613093](./image-20211023172613093.png)

- `第一种`方式实例化

![image-20211023173017863](./image-20211023173017863.png)

- `第二种`方式实例化

  ![image-20211023173203472](./image-20211023173203472.png)



![image-20211023173239052](./image-20211023173239052.png)

### 5. 自定义 redisTemplate

> 可用自定义的序列化方式

![image-20211023173839800](./image-20211023173839800.png)
...
![image-20211024115349586](./image-20211024115349586.png)

> Include: 包含,配合多个配置文件一起导入

![image-20211024115522417](./image-20211024115522417.png)
...
![image-20211024135230753](./image-20211024135230753.png)
...
![image-20211024135326694](./image-20211024135326694.png)
...
`发布订阅消息图`:![image-20211024154326014](./image-20211024154326014.png)
...
![image-20211024163202502](./image-20211024163202502.png)
...
![image-20211024180931188](./image-20211024180931188.png)
...
![image-20211024181441302](./image-20211024181441302.png)

> 配置前

- 三张配置信息

![image-20211024181612625](./image-20211024181612625.png)

![image-20211024181637984](./image-20211024181637984.png)



![image-20211024181722548](./image-20211024181722548.png)
...
![image-20211025154611577](./image-20211025154611577.png)

`从节点2`

![image-20211025155033467](./image-20211025155033467.png)

`主节点`:

![image-20211025155125689](./image-20211025155125689.png)

### 4. 主机写入,从机读取

`主机写入`

![image-20211025185848277](./image-20211025185848277.png).

`从机读取`,没有问题, 从机写入,会报异常

![image-20211025185938199](./image-20211025185938199.png)
...
![image-20211025191911606](./image-20211025191911606.png)

`服务器1`: 作为主节点

![image-20211026101314464](./image-20211026101314464.png)

`服务器2`:既是主节点,也是从节点

![image-20211026101515562](./image-20211026101515562.png)

`服务器3`: 作为`服务器2`的从节点

![image-20211026101615469](./image-20211026101615469.png)
...
![image-20211026113339442](./image-20211026113339442.png)
...
![image-20211027144644777](./image-20211027144644777.png)

![image-20211027144736927](./image-20211027144736927.png)



![image-20211027144803271](./image-20211027144803271.png)
...
![image-20211027164346141](./image-20211027164346141.png)

![luzhi_4](./luzhi_4.gif)

切换时日志: 

![image-20211027171058507](./image-20211027171058507.png)
